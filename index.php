...
<title>CYBER SECURITY SELF ASSESSMENT TOOL </title>
...
<div class="col-lg-6">
<span class="logo" >
  <img src="image/ict.png" alt="logo" class="img">
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title3"><span style="color:blue;font-family:'arial'" ><b>Log In To Your Account</b></span></h4>
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
   ...
   <option value="Male"><b>Select Gender</b></option>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your Province" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" value="Sign Up" class="btn btn-success"style="background-color:DarkOrchid"/>
  </div>
</div>
...
<a href="http://www.ictministry.gov.zw/" target="http://www.ictministry.gov.zw/"><b>About us</b></a>
</div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#login"><b>Admin Login</b></a></div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers"><b>©2021 ICT SECURITY UNIT</b></a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/ict.png" width=150 height=50 alt="Sunny Prakash Tiwari">
		 </div>
		 <div class="col-md-5">
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:blue;font-family:'arial' ">LOGIN TO ADMIN PANEL</span></h4>
      </div>
