...
<div class="col-lg-6">
<span class="logo">
  <img src="image/ict.png" alt="" class ="img">
</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>ICT SECURITY UNIT</b></a>
    </div>
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Province</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
<a href="http://www.ictministry.gov.zw/" target="http://www.ictministry.gov.zw/">About us</a>
</div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#login">Admin Login</a></div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers">©2021 ICT SECURITY UNIT</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/flagx50.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		...
		<h4 style="font-family:'typo' ">To provide an efficient national information communication technology delivery framework and maintain national cyber security</h4></div></div>
		</p>
      </div>
